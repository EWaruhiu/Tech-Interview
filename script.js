...
<div class = "col2" onclick="more(${value.imdbID})"><img src= ${value.Poster} width="100%"><br>
${value.Title}<br>
${value.Year}<br>
${value.Rated}<br>
${value.Genre} 
...
${value.Website}
		...
		</div><div class = "col3" onclick="more(${value.imdbID})"><img src= ${value.Poster} width="100%"><br>
${value.Title}<br>
${value.Year}<br>
${value.Rated}<br>
${value.Genre} 
